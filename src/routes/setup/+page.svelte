...
>
    ...
    <div class="flex flex-col items-center mb-8">
        ...
        <div class="max-w-prose mx-auto my-4 leading-relaxed">
            ...
            <p>
                В <Highlight text="Средние века" color={4} /> печать была основана
                на использовании
                <Highlight text="металлических блоков" color={5} /> с вырезанными
                текстами и изображениями. Эти блоки использовались для печати на
                <Highlight text="бумаге и других материалах." color={6} /> В это
                время печать была важной частью <Highlight
                    text="книжной иллюстрации"
                    color={7}
                /> и использовалась для создания иллюстрированных изданий.
            </p>
            <p>
                В <Highlight text="Новое время" color={8} /> печать была основана
                на использовании
                <Highlight
                    text="типографии, которая была изобретена в XV веке."
                    color={9}
                /> Типография позволяла массово производить печатные издания, что
                стало важным шагом в развитии печати. В это время печать стала важной
                частью массовой культуры и использовалась для <Highlight
